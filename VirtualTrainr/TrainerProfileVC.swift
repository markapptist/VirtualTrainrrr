...
class TrainerProfileVC:  UIViewController {
    ...
    override func viewDidLoad() {
        ...
        tabBtn2.setImage(#imageLiteral(resourceName: "profile_money_ic"), for: .normal)
    ...
    func tabBtn1Pressed() {
        ...
        if !tabBtn1.isSelected {
            ...
            tabSwitch.setTitle("About Me", forSegmentAt: 0)
            tabSwitch.setTitle("Reviews", forSegmentAt: 1)
            
        }
        
        if tabBtn2.isSelected {
            tabBtn2.backgroundColor = UIColor.black
            tabBtn2.setImage(#imageLiteral(resourceName: "profile_money_ic.png"), for: .normal)
    ...
    func tabBtn2Pressed() {
        ...
        if !tabBtn2.isSelected {
            ...
            tabSwitch.setTitle("Sessions", forSegmentAt: 0)
            tabSwitch.setTitle("Packages", forSegmentAt: 1)
    ...
    func indexChanged() {
        ...
        if tabBtn2.isSelected {
            ...
            case 0:
                print("profile tab")
                sessions.view.frame = containerView.bounds
                self.addChildViewController(sessions)
                containerView.addSubview(sessions.view)
                
                if(sessions.isViewLoaded) {
                    
                    if(sessions.view.isHidden) {
                        sessions.view.isHidden = false
                    }
            ...
            case 1:
                print("my trainers")
                packages.view.frame = containerView.bounds
                self.addChildViewController(packages)
                containerView.addSubview(packages.view)
                
                if(packages.isViewLoaded) {
                    
                    if(packages.view.isHidden) {
                        packages.view.isHidden = false
                    }
