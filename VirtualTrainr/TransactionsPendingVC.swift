...
class TransactionsPendingVC: UIViewController , UITableViewDelegate, UITableViewDataSource {
    ...
    override func viewDidLoad() {
        ...
        availableBalanceView.leadingAnchor.constraint(equalTo: self.view.leadingAnchor, constant: 30).isActive = true
        availableBalanceView.topAnchor.constraint(equalTo: self.view.topAnchor).isActive = true
        availableBalanceView.trailingAnchor.constraint(equalTo: self.view.trailingAnchor, constant: -30).isActive = true
        ...
        availableBalanceLbl.text = "Pending Balance"
        ...
        tableView.topAnchor.constraint(equalTo: availableBalanceView.bottomAnchor, constant: 0).isActive = true
        tableView.leadingAnchor.constraint(equalTo: availableBalanceView.leadingAnchor).isActive = true
        tableView.trailingAnchor.constraint(equalTo: availableBalanceView.trailingAnchor).isActive = true
